...
const surveys = [
  {
    ...
    description: `探偵事務所に寄せられる相談で一番多いのがこの浮気・不倫調査。確証が持てなくても大丈夫。怪しいとに感じたらすぐご連絡ください。事実確認のための調査も受け付けております。`,
  },
  {
    title: '婚前調査',
    bg: 'bg-green-900',
    image: '/images/investigate/investigate-2.jpg',
    description: `将来の配偶者やパートナーの様子がおかしいと感じたら その怪しい行動には必ず理由があります。まずは、あなたのお悩みをお聞かせください。`,
  },
  {
    title: '行方調査',
    bg: 'bg-blue-900',
    image: '/images/investigate/investigate-3.jpg',
    description: `家出をした息子を探したい。お金を貸した友人と連絡が取れない 我々は行方調査や人探しの専門家です。まずは、あなたのご相談をお聞かせください。`,
  },
  {
    title: '素行調査',
    bg: 'bg-purple-800',
    image: '/images/investigate/investigate-4.jpg',
    description: `離れて暮らす息子の様子を知りたい 夫が浮気ではないが、隠し事をしている 不自然な行動の背後には常に何かしらの理由が隠されています まずは、あなたのお悩みをお聞かせください。`,
  },
  {
    title: 'いじめ調査',
    bg: 'bg-pink-900',
    image: '/images/investigate/investigate-5.jpg',
    description: `子供の元気がなくなった。敷地内にゴミを散らかされる SNS全盛の現代、教師がいじめに全く気づいていないなんてことも珍しくはありません。私たち探偵が原因となる証拠を掴み、解決に導きます。`,
  },
  {
    title: 'ストーカー調査',
    bg: 'bg-cyan-800',
    image: '/images/investigate/investigate-6.jpg',
    description: `自宅や職場の近くで頻繁に見かける人がいる。一方的にしつこく連絡をしてくる人がいる。全く知らない人から荷物や手紙が届く。怖い思いをさせているストーカーから、あなたを守ります。`,
  },
  {
    title: '盗聴器探査調査',
    bg: 'bg-rose-300',
