...
const flows = [
  ...
  },
  {
    ...
    description: `お客様からの情報をもとに、監視、尾行、情報収集などの調査を行います
必要な証拠や情報を収集し、写真や動画などで記録します
プライバシーに配慮した調査を行い、安心してご利用いただけます
複数の調査員を動員する場合でも、追加料金は発生しません`,
  },
  {
    title: '5.中間報告',
    bg: 'bg-red-100',
  ...
  },
  {
    ...
    description: `確実な証拠を得て、詳細な報告書を作成し提出します。結果に基づき、裁判などの法的手段を取る際には、報告書があなたの強力な武器となります。その後の相談等、アフターサービスも無料で行っております。`,
  },
]
