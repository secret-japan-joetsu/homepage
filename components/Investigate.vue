<script setup lang="ts">
  const description = `パートナーの浮気で、お悩みの方は決して少なくありません 。1人で悩んでいる方、 話し合いの糸口がつかめないで諦めている方、 勇気を出して話し合っても、はぐらかされて一向に解決しない方など、 多くの方が心のモヤモヤを解消できずに悩んでおられます。 パートナーをしっかり認めさせ、事実を明らかにする為には、言い訳の出来ない確たる証拠が必要です。 自分自身や家族の未来のために、一歩を踏み出しましょう。 我々が浮気や不倫のトラブル解決のお手伝いをします。`
